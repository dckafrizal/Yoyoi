    ...
    try {
        ...
        if (global.db.data.users[m.sender].health > 79) {
            if (new Date() - global.db.data.users[m.sender].lastmining > 180000) {
                ...
                let health = (kucing == 0 && armor == 0 ? pickRandom(['100', '99', '98', '97', '96', '95', '94', '93', '92', '91', '90']) : kucing > 0 && armor > 0 ? __health : ___health)
...
`.trim()
    ...
    contextInfo: {
        externalAdReply: {
            mediaType: 1,
            title: 'AXELLDX',
            thumbnailUrl: 'https://telegra.ph/file/755ad983866f5f7057d91.jpg',
        ...
        } else conn.reply(m.chat, 'minimum 80 health to do chopping', m)
    } catch (e) {
        console.log(e)
