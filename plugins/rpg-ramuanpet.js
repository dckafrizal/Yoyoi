    ...
    switch (type) {
      ...
      case 'centaur':
        ...
        case 'hero':
            ...
            break
        default:
            return conn.reply(m.chat, `乂 *P O T I O N*\n\n Berikut adalah beberapa *Ramuan* yang bisa anda gunakan kepada pet anda :\n- hero\n- kucing\n- rubah\n- kuda\n- naga\n- centaur\n- phonix\n- serigala\n\n_Example_ : *${usedPrefix}ramuan kucing*`, m, {
      contextInfo: {
        externalAdReply: {
          mediaType: 1,
          title: 'AXELLDX',
          thumbnailUrl: 'https://telegra.ph/file/ed4d2eb227d1e4c0bf99f.jpg',
